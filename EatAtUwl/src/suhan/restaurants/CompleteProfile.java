...
Spinner spinner;
	...
	// single product url
	private static final String url_product_detials = "http://doctorsdekho.com/dpk/subadminlist.php";

	// url to update product
	private static final String url_update_product = "http://doctorsdekho.com/dpk/subadminlistupdate.php";
	...
	spinner = (Spinner) findViewById(R.id.spinner1);
		...
		btnSave.setOnClickListener(new View.OnClickListener() {
	    	...
	    	//Check all fields		
				if(card.length()<4)
				{
					Toast.makeText(CompleteProfile.this,"Please fill full details", Toast.LENGTH_LONG).show();
					return;
				}
				 if(address.length()<4)
				{				
	...
	class GetProductDetails extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CompleteProfile.this);
	...
	class SaveProductDetails extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			String name = card.getText().toString();
			String price = address.getText().toString();
			String description = city.getText().toString();
			String spin=spinner.toString();
			// Building Parameters
			List<NameValuePair> params = new ArrayList<NameValuePair>();
