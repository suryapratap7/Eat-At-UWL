...
public class EditProductActivity1 extends Activity {
...
ImageView img1;
	...
	// single product url
	private static final String url_product_detials = "http://desirecharge.in/suhan/nearbydetails.php";
	...
	class GetProductDetails extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(EditProductActivity1.this);
